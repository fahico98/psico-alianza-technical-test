<x-app-layout>
    <div class="w-full h-[500px] flex flex-col justify-center items-center gap-y-4">
        ...
        Esta seguro de eliminar {{ count($employees) }} empleados?
        <div class="flex justify-center gap-x-2">
            <x-button onclick="location.href='{{ route('delete-many-employees', compact('employees')) }}'">Si</x-button>
            <x-button onclick="location.href='{{ route('employees') }}'">No</x-button>
        </div>
    </div>
</x-app-layout>